...
@section('title', 'About Codelab Web Tech - Our Story and Mission')
                ...
                <div class="row clearfix">
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="{{ url('services') }}"><img src="{{ asset('assets/images/resource/featured-image-4.jpg') }}" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="{{ url('services') }}"><img src="{{ asset('assets/images/resource/featured-image-5.jpg') }}" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="{{ url('services') }}"><img src="{{ asset('assets/images/resource/featured-image-6.jpg') }}" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
