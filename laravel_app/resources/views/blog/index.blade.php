...
@section('title', 'Blog - Codelab Web Tech')
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <a href="{{ url('blog/single') }}"><img src="{{ asset('assets/images/resource/blog-image-1.jpg') }}" alt="" title=""></a>
                        </div>
                        <div class="lower-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <a href="{{ url('blog/single') }}"><img src="{{ asset('assets/images/resource/blog-image-2.jpg') }}" alt="" title=""></a>
                        </div>
                        <div class="lower-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <a href="{{ url('blog/single') }}"><img src="{{ asset('assets/images/resource/blog-image-3.jpg') }}" alt="" title=""></a>
                        </div>
                        <div class="lower-box">
