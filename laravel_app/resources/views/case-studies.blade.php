...
@section('title', 'Case Studies - Codelab Web Tech')
                ...
                <div class="row clearfix">
                    ...
                    <div class="case-block col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <figure class="image-box">
                                <a href="{{ url('case-studies/single') }}"><img src="{{ asset('assets/images/resource/case-image-1.jpg') }}" alt="" title=""></a>
                            </figure>
                    ...
                    <div class="case-block col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <figure class="image-box">
                                <a href="{{ url('case-studies/single') }}"><img src="{{ asset('assets/images/resource/case-image-2.jpg') }}" alt="" title=""></a>
                            </figure>
                            <div class="content-box">
                                <div class="title-box">
                    ...
                    <div class="case-block col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <figure class="image-box">
                                <a href="{{ url('case-studies/single') }}"><img src="{{ asset('assets/images/resource/case-image-4.jpg') }}" alt="" title=""></a>
                            </figure>
                            <div class="content-box">
                                <div class="title-box">
                    ...
                    <div class="case-block col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <figure class="image-box">
                                <a href="{{ url('case-studies/single') }}"><img src="{{ asset('assets/images/resource/case-image-5.jpg') }}" alt="" title=""></a>
                            </figure>
                            <div class="content-box">
                                <div class="title-box">
