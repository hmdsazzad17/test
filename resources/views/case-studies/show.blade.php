                ...
                <div class="case-images">
                    <div class="row clearfix">
                        ...
                        <div class="image-column col-lg-8 col-md-8 col-sm-12">
                            <figure class="image">
                                <a href="{{ asset('images/resource/case-image-6.jpg') }}" class="lightbox-image"><img src="{{ asset('images/resource/case-image-6.jpg') }}" alt=""></a>
                            </figure>
                        </div>
                        <!--Image Column-->
                        <div class="image-column col-lg-4 col-md-4 col-sm-12">
                            <figure class="image">
                                <a href="{{ asset('images/resource/case-image-7.jpg') }}" class="lightbox-image"><img src="{{ asset('images/resource/case-image-7.jpg') }}" alt=""></a>
                            </figure>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="image-column col-lg-7 col-md-12 col-sm-12">
                            <div class="row clearfix">
                                <div class="column col-md-6 col-sm-12">
                                    <div class="image">
                                        <a href="{{ asset('images/resource/case-image-8.jpg') }}" class="lightbox-image"><img src="{{ asset('images/resource/case-image-8.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="column col-md-6 col-sm-12">
                                    <div class="image">
                                        <a href="{{ asset('images/resource/case-image-9.jpg') }}" class="lightbox-image"><img src="{{ asset('images/resource/case-image-9.jpg') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
