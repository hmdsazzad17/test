            ...
            <div class="slide-item">
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <div class="content-image"><img src="{{ asset('images/main-slider/content-image-2.png') }}" alt="" title=""></div>
                    </div>  
                </div>
            </div>
        	...
        	<div class="row clearfix">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="images">
                            <div class="row clearfix">
                                <figure class="image col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="{{ asset('images/resource/about-image-1.jpg') }}" alt="" title=""></figure>
                                <figure class="image col-md-6 col-sm-6 wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="{{ asset('images/resource/about-image-2.jpg') }}" alt="" title=""></figure>
                                <figure class="image col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="{{ asset('images/resource/about-image-3.jpg') }}" alt="" title=""></figure>
                                <figure class="image col-md-6 col-sm-6 wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="{{ asset('images/resource/about-image-4.jpg') }}" alt="" title=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
